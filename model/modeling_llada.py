...
class LLaDABlock(nn.Module):
    ...
    def _scaled_dot_product_attention(
        ...
        if self.flash_attn_func is not None and attn_mask is None:
            ...
            # A boolean attention mask has True for allowed query/key pairs.
            # In a padded batch it prevents padded K/V positions from affecting
            # real tokens; an all-True mask is equivalent to the old unmasked
            # non-padding behavior.
