"""Small, explicit YAML-to-runner configuration loader."""
...
def load_train_config(config_path: Path, resume_from_checkpoint: Path | None = None) -> argparse.Namespace:
    ...
    manifest = os.environ.get(paths["train_manifest_env"], str(Path(data_root) / "official_tokens/train/manifest.jsonl"))
